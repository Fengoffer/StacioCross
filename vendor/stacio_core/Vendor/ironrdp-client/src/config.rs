...
pub struct Config {
    ...
    pub(crate) ignore_certificate: bool,
...
impl Config {
    ...
    /// Whether this connection bypasses TLS certificate and hostname verification.
    pub fn ignore_certificate(&self) -> bool {
        self.ignore_certificate
    }
...
impl fmt::Debug for Config {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        s.field("ignore_certificate", &self.ignore_certificate);
...
pub enum ClipboardType {
    ...
    Disable,
    /// Advertise clipboard redirection while a caller-provided static channel
    /// supplies the backend. No native or stub backend is created.
    External,
...
impl ConfigBuilder {
    ...
    /// Set the visual-effects policy advertised in the Client Info PDU.
    #[must_use]
    pub fn with_performance_flags(
        mut self,
        flags: ironrdp_pdu::rdp::client_info::PerformanceFlags,
    ) -> Self {
    ...
    /// Bypass TLS certificate and hostname verification for this connection only.
    #[must_use]
    pub fn with_ignore_certificate(mut self, ignore_certificate: bool) -> Self {
    ...
    pub fn with_clipboard(mut self, mode: ClipboardType) -> Self {
        ...
        self.properties
            .set_redirect_clipboard(matches!(mode, ClipboardType::Enable | ClipboardType::External));
        self
    }
